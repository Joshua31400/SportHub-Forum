...
func (h *GitHubAuthHandler) getUserInfoFromGitHub(accessToken string) (*models.GitHubUserInfo, error) {
	client := &http.Client{}
...
func (h *GitHubAuthHandler) processGitHubUser(githubUser *models.GitHubUserInfo) (*models.User, error) {
	...
	if githubUser.Email != "" {
		_, err := database.GetUserByEmail(githubUser.Email)
		if err == nil {
